...
export type ReasoningProps = ComponentProps<typeof Collapsible> & {
  ...
  duration?: number;
  /** When false, reasoning stays expanded after streaming ends. */
...
export const ReasoningContent = memo(
  ({ className, children, ...props }: ReasoningContentProps) => {
    ...
    return (
      <div
        className={cn(
          "mt-2 animate-in fade-in-0 duration-200 text-foreground/80 [overflow-anchor:none]",
          className
        )}
      >
        <div
          className="max-h-[280px] overflow-y-auto rounded-xl border border-primary/10 bg-primary/[0.03] px-3.5 py-2.5 text-[12px] leading-relaxed"
          ref={scrollRef}
